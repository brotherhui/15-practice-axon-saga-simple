...
public class CreateBankTransferCommand {
    ...
    //this will routine to AggregateIdentifier of bankTransferId in BankTransfer Aggregrate
	...
	public CreateBankTransferCommand(String bankTransferId, String sourceBankAccountId, String destinationBankAccountId,
			long amount) {
		super();
		this.bankTransferId = bankTransferId;
		this.sourceBankAccountId = sourceBankAccountId;
